/**
 * End-to-end check for the EduForge world (Person A done-checklist).
 *
 ...
 *   VERIFY_URL=http://localhost:3000 node scripts/verify-world.mjs
 */
...
const t0 = await page.evaluate(() => window.__eduforge.state().elapsed);
await page.evaluate(() => window.advanceTime(3000));
const t1 = await page.evaluate(() => window.__eduforge.state().elapsed);
