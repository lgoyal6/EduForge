...
export const MOCK_RUN_ID = "run_eduforge_demo";
...
export const mockConcepts: ConceptSummary[] = [
  {
...
export const mockVariants: AssignmentVariant[] = [
  {
...
export const mockAssessments: AssessmentResult[] = seedAssessments.map((seed, index) => ({
...
export const mockLessonPlan: LessonPlan = {
