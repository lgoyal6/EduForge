...
describe("grouping agent", () => {
  ...
  it("creates three or four rooms, each at or above the minimum size", () => {
  ...
  it("groups by academic barrier: each room's members share its signature misconception", () => {
    const plan = buildGroupingPlan(contexts, analysis);
  ...
  it("sends only barrier-free, high-mastery students to Summit", () => {
    const plan = buildGroupingPlan(contexts, analysis);
  ...
  it("never lets a documented support move a student", () => {
  ...
  it("scores support_compatibility identically across every room", () => {
  ...
  it("declares the signals it used and the labels it refused to read", () => {
    const plan = buildGroupingPlan(contexts, analysis);
  ...
  it("never names a room after a diagnosis or an accommodation", () => {
    const plan = buildGroupingPlan(contexts, analysis);
    const banned = [
      ...supportIds,
      "iep",
  ...
  it("cites evidence in every room explanation and placement", () => {
    const plan = buildGroupingPlan(contexts, analysis);
    for (const room of plan.rooms) {
  ...
  it("applies a fragmentation penalty only above the soft capacity", () => {
  ...
  it("dissolves a room that cannot reach the minimum size", () => {
  ...
  it("emits groups.proposed with room membership", () => {
